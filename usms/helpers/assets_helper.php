...
if (!function_exists('_getConfig'))
{
  ...
  {
    $CI =& get_instance();
    $CI->load->config('config_template');
    $config = array();
    ...
    $config['path_base_url']  = $CI->config->item('path_base_url');
...
if (!function_exists('assets_css'))
{
  ...
  {
    echo _assets_base($file, $attr, 'css');
  }
}
...
if (!function_exists('assets_js'))
{
  ...
  {
    echo _assets_base($file, $attr, 'js');
  }
}
...
if (!function_exists('assets_img'))
{
  ...
  {
    echo _assets_base($file, $attr, 'img');
  }
}
if (!function_exists('assets_base_url'))
{
  function assets_base_url($file, $attr = array())
  {
    echo _assets_base($file, $attr, 'base_url');
  }
}
