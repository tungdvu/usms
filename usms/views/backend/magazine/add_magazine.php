    ...
    <div class="message-div"></div>
        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                <?php //var_dump($user); ?>
                <div class="row">
                    <form id="form_addmagazine" autocomplete="off" action="" method="post" enctype="multipart/form-data">
                        <div class="col-md-12 col-xs-12 col-lg-12">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12 col-md-5">
                                    ...
                                    placeholder="" autocomplete="off" value="<?php echo set_value('Magazine_Name');?>" />
                                </div>                           
                                <div class="form-group col-xs-12 col-md-3">
                                    <label class="form-control-label" for="Type">Loại</label>
                                    <select class="form-control" id="" name="Type" data-plugin="select2">
                                        <option value="1" <?php echo set_select('Type', '1', TRUE); ?>>Tạp chí</option>
                                        <option value="2" <?php echo set_select('Type', '2', TRUE); ?>>Hội thảo</option>
                                        <option value="3" <?php echo set_select('Type', '3', TRUE); ?>>Kỷ yếu</option>
                                    </select>
                                </div>                           
                                <div class="form-group col-xs-12 col-md-2">
                                    ...
                                    placeholder="" autocomplete="off" value="<?php echo set_value('Magazine_No');?>" />
                                </div>                           
                                <div class="form-group col-xs-12 col-md-2">
                                    <label class="form-control-label" for="Magazine_Year">Năm</label>
                                    <span class="required">*</span>
                                    <input type="text" class="form-control" name="Magazine_Year"
                                    placeholder="" autocomplete="off" id="Magazine_Year" value="<?php echo set_value('Magazine_Year');?>" />
                                </div>
                            </div>
                            <div class="row">                           
                                <div class="form-group col-xs-12 col-md-5">
                                ...
                                <div class="form-group col-xs-12 col-md-3">
                                    ...
                                    <select class="form-control" id="" name="Type_Area" data-plugin="select2">
                                        <option value="0" <?php echo set_select('Type_Area', '0', TRUE);?>>Trong nước</option>
                                        <option value="1" <?php echo set_select('Type_Area', '1', TRUE);?>>Quốc tế</option>
                                    </select>                                           
                                </div>                           
                                <div class="form-group col-xs-12 col-md-2">
                                    ...
                                    placeholder="" autocomplete="off" value="<?php echo set_value('Page_Start');?>"/>                                           
                                </div>                           
                                <div class="form-group col-xs-12 col-md-2">
                                    <label class="form-control-label" for="Page_End">Trang kết thúc</label>
                                    <span class="required">*</span>
                                    <input type="text" class="form-control" name="Page_End"
                                    placeholder="" autocomplete="off" value="<?php echo set_value('Page_End');?>" />                                           
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-12 col-md-5">
                                    ...
                                    placeholder="" autocomplete="off" value="<?php echo set_value('Branch');?>"/>
                                </div>
                                <div class="form-group col-xs-12 col-md-7">
                                    <label class="form-control-label" for="Keyword">Từ khóa</label>
                                    <span class="required">*</span>
                                    <input type="text" name="Keyword" class="form-control" id="keyword" value="<?php echo set_value('Keyword');?>" placeholder="Nhập từ khóa và nhấn Enter" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-12 col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                placeholder="" autocomplete="off" value="<?php echo set_value('Project_ID');?>" />
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="Summary">Tóm tắt bài báo</label>
                                    <span class="required">*</span>
                                <textarea class="form-control" id="textarea" name="Summary" value="<?php echo set_value('Summary');?>" rows="3"></textarea>
                            </div>
