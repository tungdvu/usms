<section class="cat-box list-box">
  <div class="cat-box-content">
  	...
  	<h2 class="post-box-title">Thêm bài viết</h2>
  	<?php
    ...
    ?>
  		<form action="" method="post" enctype="multipart/form-data">
			...
			<p><label>Tiêu Đề: </label>
				<input class="form-control" type="text" name="title" id="title" value="<?=set_value('title');?>" required placeholder="Nhập tiêu đề tin...">
			</p>
			<p><label>Mô Tả: </label>
				<input class="form-control"  type="text" name="description" id="description" value="<?=set_value('description');?>" required placeholder="Nhập mô tả...">
			</p>
			<p><label>Nội Dung: </label>
				<textarea class="form-control ckeditor" name="detail" id="detail" required placeholder="Nhập nội dung ..." ><?=set_value('detail');?></textarea>
			</p>
